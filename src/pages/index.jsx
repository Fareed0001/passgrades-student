    ...
    <>
      <div className="landingPageDiv">
        <Head>
          ...
          <meta name="description" content="Landing page for passmark" />
                    ...
                    <div className="nav-div-1">
                      <p className="index-logo-text">
                        ...
                        <Image
                          ...
                          height={30}
                          width={30}
                          className="mx-1 index-logo-icon"
                        />
            ...
            <div className="first-div container">
              <div className="row">
                ...
                <div className="first-div-col0 col-md order-md-1">
                  <p className="first-div-title-text">
              ...
              <div className="second-div-card-div row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-6">
                <div className="second-div-card col-md-2">
                  <img
                    ...
                    alt="business-icon"
                  />
                  <p className="second-div-text">IELTS general</p>
                </div>
                <div className="second-div-card  col-md-2">
                  <img
                    className="second-div-icon"
                    ...
                    alt="design-icon"
                  />
                  <p className="second-div-text">IELTS academia</p>
                </div>
                <div className="second-div-card  col-md-2">
                  <img
                    className="second-div-icon"
                    ...
                    alt="writing-icon"
                  />
                  <p className="second-div-text">Selt Academia</p>
                </div>
                <div className="second-div-card  col-md-2">
                  <img
                    className="second-div-icon"
                    ...
                    alt="web-dev-icon"
                  />
                  <p className="second-div-text">Gre Academia</p>
                </div>
                <div className="second-div-card  col-md-2">
                  <img
                    className="second-div-icon"
                  ...
                  />
                  <p className="second-div-text">PTE general</p>
                </div>
              </div>
            </div>
            {/* <!-- SECOND DIV END -->
                ...
                <p className="seventh-div-header">
                  ...
                  <span className="seventh-div-logo">
                    ...
                    <Image
                      ...
                      className="mx-2"
                    />
                    <span className="seventh-logo-span0">grades </span>
                  </span>
                  has to offer.
                </p>
              </div>
